<div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="w-100" style="height: 1080px;" src="{{ asset('img/background-image.jpg') }}" alt="First Image">
        ...
        <div class="carousel-item">
            <img class="w-100" style="height: 1080px" src="{{ asset('img/background-image1.jpg') }}" alt="Second Image">
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                <div class="p-3" style="max-width: 900px;">
                    <h5 class="text-white text-uppercase mb-3 animated slideInDown">Creative & Innovative</h5>
                    <h1 class="display-1 text-white mb-md-4 animated zoomIn">Creative & Innovative Design Solution
